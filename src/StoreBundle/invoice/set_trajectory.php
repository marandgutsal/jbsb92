...
namespace StoreBundle\invoice;

use Symfony\Bundle\FrameworkBundle\Controller\Controller;
use Symfony\Component\HttpFoundation\Response;
use Symfony\Component\HttpFoundation\Request;

class set_trajectory extends Controller {

    public $global_topicId = 0;
    
    public function isValid($em, $sale_id)
    {
//        $valor1 = $this->getUserTypeId($em, $usertypeClass);
        $this->setShipment($sale_id);
        $valor1 = 1;
        
        return $valor1;
    }
    
    public function setShippingUser($sale_id, $db2) // sale - saleDetail
    {
        $query_nm = " 
            UPDATE `sale` 
            SET 
