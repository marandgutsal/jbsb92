...
class Reach_1_international extends Controller {

    public $global_topicId = 0;
    
    public function isValid($db2, $location_id)
    {
        $valor1 = $this->getShipmentInternational($db2, $location_id);
        
        return $valor1;
    }
    
    public function getShipmentInternational($db2, $location_id)
    {
        $string_d_1 = "";
        $string_d_1 .= 
        "
