...
class Reach_4_departamental extends Controller {

    public $global_topicId = 0;
    
    public function isValid($db2, $location_id)
    {
        $valor1 = $this->getShipmentDepartamental($db2, $location_id);
//        $valor1 = 1;
        
        return $valor1;
    }
    
    public function getShipmentDepartamental($db2, $location_id)
    {
        $string_d_1 = "";
        $string_d_1 .= 
        "
            SELECT DISTINCT 
                ...
                WHERE departamental_store.location_id = departamental_customer.location_id and 
                departamental_customer.location_id = '$location_id' 
        ";
