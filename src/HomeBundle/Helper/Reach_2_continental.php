...
class Reach_2_continental extends Controller {

    public $global_topicId = 0;
    
    public function isValid($db2, $location_id)
    {
        $valor1 = $this->getShipmentContinental($db2, $location_id);
        return $valor1;
    }
    
    public function getShipmentContinental($db2, $location_id)
    {
        $string_d_1 = "";
        $string_d_1 .= 
        "
            SELECT DISTINCT 
                ...
                WHERE continental_store.location_id = continental_customer.location_id and 
                continental_customer.location_id = '$location_id' 
        ";
