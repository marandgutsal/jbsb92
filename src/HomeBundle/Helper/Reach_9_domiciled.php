...
class Reach_9_domiciled extends Controller {

    public $global_topicId = 0;
    
    public function isValid($db2, $location_id)
    {
        $valor1 = $this->getShipmentDomiciled($db2, $location_id);
//        $valor1 = 1;
        
        return $valor1;
    }
    
    public function getShipmentDomiciled($db2, $location_id)
    {
        $string_d_1 = "";
        $string_d_1 .= 
        "
            SELECT DISTINCT 
                ...
                WHERE domiciled_store.location_id = domiciled_customer.location_id and 
                domiciled_customer.location_id = '$location_id' 
        ";
