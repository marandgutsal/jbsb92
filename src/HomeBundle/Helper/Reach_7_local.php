...
class Reach_7_local extends Controller {

    public $global_topicId = 0;
    
    public function isValid($db2, $location_id)
    {
        $valor1 = $this->getShipmentLocal($db2, $location_id);
//        $valor1 = 1;
        
        return $valor1;
    }
    
    public function getShipmentLocal($db2, $location_id)
    {
        $string_d_1 = "";
        $string_d_1 .= 
        "
            SELECT DISTINCT 
                ...
                WHERE local_store.location_id = local_customer.location_id and 
                local_customer.location_id = '$location_id' 
        ";
