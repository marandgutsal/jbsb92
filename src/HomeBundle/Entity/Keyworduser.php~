 ...
 * Keyworduser
 *
 * @ORM\Table(name="keywordUser", uniqueConstraints={@ORM\UniqueConstraint(name="keyword_id", columns={"keyword_id", "user_id"})}, indexes={@ORM\Index(name="user_id", columns={"user_id"}), @ORM\Index(name="userIp_id", columns={"userIp_id"}), @ORM\Index(name="IDX_8E6A6583115D4552", columns={"keyword_id"})})
 * @ORM\Entity
 */
class Keyworduser
{
