...
class Sale
{
     ...
     * @ORM\JoinColumns({
     *   @ORM\JoinColumn(name="customer_id", referencedColumnName="branch_id")
     * })
     */
    private $customer;
     ...
     * Set customer
     *
     * @param \HomeBundle\Entity\Branch $customer
     *
     * @return Sale
     */
    public function setCustomer(\HomeBundle\Entity\Branch $customer = null)
    {
