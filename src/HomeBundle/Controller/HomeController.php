...
class HomeController extends Controller
{
    ...
    {
        return $this->render('@Home/home/homeTest.html.twig');
    }
...
//                    ";
    ...
    public function homeAction()
    {
        ...
        $get_location_form_ajax = $this->createCustomForm(
        'HomeBundle\Form\TaskType', $taskEntity, 'POST', 'get_location_form');
        ...
        $edit_window_store_form_ajax = $this->createCustomForm(
        'HomeBundle\Form\TaskType', $taskEntity, 'POST', 'edit_window_store_form');
        
        $get_topic_form_ajax = $this->createCustomForm(
        'HomeBundle\Form\TaskType', $taskEntity, 'POST', 'get_topic_form');
        
        $get_products_form_ajax = $this->createCustomForm(
        'HomeBundle\Form\TaskType', $taskEntity, 'POST', 'get_products_form');
        
        $insert_object_form_ajax = $this->createCustomForm(
        'HomeBundle\Form\TaskType', $taskEntity, 'POST', 'insert_object_form');
        
        $get_userType_form_ajax = $this->createCustomForm(
        'HomeBundle\Form\TaskType', $taskEntity, 'POST', 'get_userType_form');
        
        $search_language_form_ajax = $this->createCustomForm(
        'HomeBundle\Form\TaskType', $taskEntity, 'POST', 'search_language_form');
        
        $insert_location_form_ajax = $this->createCustomForm(
        'HomeBundle\Form\TaskType', $taskEntity, 'POST', 'insert_location_form');
        
        
         
        $storeBundle = $this->get_storeBundle_routes($taskEntity);
        $shippingBundle = $this->get_shippingBundle_routes($taskEntity);
        $sessionBundle = $this->get_sessionBundle_routes($taskEntity);
        $signupBundle = $this->get_signupBundle_routes($taskEntity);
        $uploadproductBundle = $this->get_uploadproductBundle_routes($taskEntity);
        $dataminingBundle = $this->get_dataminingBundle_routes($taskEntity);
...
//            'store' => $store, 
        ...
        return $this->render('@Home/home/home.html.twig', 
            ...
            'get_location_form_ajax' => $get_location_form_ajax->createView(),
            ...
            'edit_window_store_form_ajax' => $edit_window_store_form_ajax->createView(),
            'get_topic_form_ajax' => $get_topic_form_ajax->createView(),
            'get_products_form_ajax' => $get_products_form_ajax->createView(),
            'insert_object_form_ajax' => $insert_object_form_ajax->createView(),
            'get_userType_form_ajax' => $get_userType_form_ajax->createView(),
            'search_language_form_ajax' => $search_language_form_ajax->createView(),
            'insert_location_form_ajax' => $insert_location_form_ajax->createView(),
            ...
            'storeBundle1' => array(
                'storeBundle2' => $storeBundle
            ),
                    
            'shippingBundle1' => array(
                'shippingBundle2' => $shippingBundle
            ),
                    
            'sessionBundle1' => array(
                'sessionBundle2' => $sessionBundle
            ),
                    
            'signupBundle1' => array(
                'signupBundle2' => $signupBundle
            ),
                    
            'uploadproductBundle1' => array(
                'uploadproductBundle2' => $uploadproductBundle
            ),
                    
            'dataminingBundle1' => array(
                'dataminingBundle2' => $dataminingBundle
            ),
    ...
    public function get_storeBundle_routes($taskEntity)
    {
        ...
        $insert_topic_product_form_ajax = $this->createCustomForm(
        'HomeBundle\Form\TaskType', $taskEntity, 'POST', 'insert_topic_product_form');
        
        $exchange_currency_form_ajax = $this->createCustomForm(
        'HomeBundle\Form\TaskType', $taskEntity, 'POST', 'exchange_currency_form');
        
        $search_topic_product_form_ajax = $this->createCustomForm(
        'HomeBundle\Form\TaskType', $taskEntity, 'POST', 'search_topic_product_form');
        
        $get_product_data_form_ajax = $this->createCustomForm(
        'HomeBundle\Form\TaskType', $taskEntity, 'POST', 'get_product_data_form');
        
        $get_saleDetail_form_ajax = $this->createCustomForm(
        'HomeBundle\Form\TaskType', $taskEntity, 'POST', 'get_saleDetail_form');
        
        $pay_selected_products_form_ajax = $this->createCustomForm(
        'HomeBundle\Form\TaskType', $taskEntity, 'POST', 'pay_selected_products_form');
        

        
        $storeBundle_routes = array(
            'delete_selected_product_form_ajax' => $delete_selected_product_form_ajax->createView(),
            'insert_topic_product_form_ajax' => $insert_topic_product_form_ajax->createView(),
            'exchange_currency_form_ajax' => $exchange_currency_form_ajax->createView(),
            'search_topic_product_form_ajax' => $search_topic_product_form_ajax->createView(),
            'get_product_data_form_ajax' => $get_product_data_form_ajax->createView(),
            'get_saleDetail_form_ajax' => $get_saleDetail_form_ajax->createView(),
            'pay_selected_products_form_ajax' => $pay_selected_products_form_ajax->createView()
        );
        
        return $storeBundle_routes;
    }
    
    public function get_shippingBundle_routes($taskEntity)
    {
        $get_shipping_form_ajax = $this->createCustomForm(
        'HomeBundle\Form\TaskType', $taskEntity, 'POST', 'get_shipping_form');

        $add_shipping_form_ajax = $this->createCustomForm(
        'HomeBundle\Form\TaskType', $taskEntity, 'POST', 'add_shipping_form');

        $get_shippingMessenger_list_form_ajax = $this->createCustomForm(
        'HomeBundle\Form\TaskType', $taskEntity, 'POST', 'get_shippingMessenger_list_form');

        $get_shipmentDetail_list_form_ajax = $this->createCustomForm(
        'HomeBundle\Form\TaskType', $taskEntity, 'POST', 'get_shipmentDetail_list_form');

        $edit_shipment_form_ajax = $this->createCustomForm(
        'HomeBundle\Form\TaskType', $taskEntity, 'POST', 'edit_shipment_form');

        $get_location_detail_form_ajax = $this->createCustomForm(
        'HomeBundle\Form\TaskType', $taskEntity, 'POST', 'get_location_detail_form');
        
        $get_packageMessenger_form_ajax = $this->createCustomForm(
        'HomeBundle\Form\TaskType', $taskEntity, 'POST', 'get_packageMessenger_form');
        
        $get_reach_from_packageMessenger_form_ajax = $this->createCustomForm(
        'HomeBundle\Form\TaskType', $taskEntity, 'POST', 'get_reach_from_packageMessenger_form');
        
        $get_sale_packageMessenger_form_ajax = $this->createCustomForm(
        'HomeBundle\Form\TaskType', $taskEntity, 'POST', 'get_sale_packageMessenger_form');
                
        $assign_sale_form_ajax = $this->createCustomForm(
        'HomeBundle\Form\TaskType', $taskEntity, 'POST', 'assign_sale_form');
        
        $get_shipping_list_form_ajax = $this->createCustomForm(
        'HomeBundle\Form\TaskType', $taskEntity, 'POST', 'get_shipping_list_form');
        
        $get_vehicle_list_form_ajax = $this->createCustomForm(
        'HomeBundle\Form\TaskType', $taskEntity, 'POST', 'get_vehicle_list_form');

        $get_driver_list_form_ajax = $this->createCustomForm(
        'HomeBundle\Form\TaskType', $taskEntity, 'POST', 'get_driver_list_form');
        
        $get_driver_form_ajax = $this->createCustomForm(
        'HomeBundle\Form\TaskType', $taskEntity, 'POST', 'get_driver_form');
        
        $get_vehicle_form_ajax = $this->createCustomForm(
        'HomeBundle\Form\TaskType', $taskEntity, 'POST', 'get_vehicle_form');
        
        $set_new_driver_form_ajax = $this->createCustomForm(
        'HomeBundle\Form\TaskType', $taskEntity, 'POST', 'set_new_driver_form');
        
        $set_new_vehicle_form_ajax = $this->createCustomForm(
        'HomeBundle\Form\TaskType', $taskEntity, 'POST', 'set_new_vehicle_form');
        
        $set_new_shipping_form_ajax = $this->createCustomForm(
        'HomeBundle\Form\TaskType', $taskEntity, 'POST', 'set_new_shipping_form');
        
        $search_ownerVehicle_form_ajax = $this->createCustomForm(
        'HomeBundle\Form\TaskType', $taskEntity, 'POST', 'search_ownerVehicle_form');
        
        $search_userDriver_form_ajax = $this->createCustomForm(
        'HomeBundle\Form\TaskType', $taskEntity, 'POST', 'search_userDriver_form');

        $search_userDriverCommercial_form_ajax = $this->createCustomForm(
        'HomeBundle\Form\TaskType', $taskEntity, 'POST', 'search_userDriverCommercial_form');
        
        $get_saleDetail_shipment_form_ajax = $this->createCustomForm(
        'HomeBundle\Form\TaskType', $taskEntity, 'POST', 'get_saleDetail_shipment_form');
        
        $get_supplier_data_form_ajax = $this->createCustomForm(
        'HomeBundle\Form\TaskType', $taskEntity, 'POST', 'get_supplier_data_form');
        
        $get_supplying_data_form_ajax = $this->createCustomForm(
        'HomeBundle\Form\TaskType', $taskEntity, 'POST', 'get_supplying_data_form');
        
        $get_item_data_form_ajax = $this->createCustomForm(
        'HomeBundle\Form\TaskType', $taskEntity, 'POST', 'get_item_data_form');
        
        $get_shipment_from_saleDetail_form_ajax = $this->createCustomForm(
        'HomeBundle\Form\TaskType', $taskEntity, 'POST', 'get_shipment_from_saleDetail_form');
        
        $get_reach_from_saleDetail_form_ajax = $this->createCustomForm(
        'HomeBundle\Form\TaskType', $taskEntity, 'POST', 'get_reach_from_saleDetail_form');
        
        $match_nodes_taster_form_ajax = $this->createCustomForm(
        'HomeBundle\Form\TaskType', $taskEntity, 'POST', 'match_nodes_taster_form');
        
        $assign_route_form_ajax = $this->createCustomForm(
        'HomeBundle\Form\TaskType', $taskEntity, 'POST', 'assign_route_form');
        
        $calculate_price_form_ajax = $this->createCustomForm(
        'HomeBundle\Form\TaskType', $taskEntity, 'POST', 'calculate_price_form');
        
        $update_shipping_founding_form_ajax = $this->createCustomForm(
        'HomeBundle\Form\TaskType', $taskEntity, 'POST', 'update_shipping_founding_form');
...
//{{ form_end(shippingBundle1.shippingBundle2.calculate_price_form_ajax) }}
        ...
        $shippingBundle_routes = array(
            'get_shipping_form_ajax' => $get_shipping_form_ajax->createView(),
            'add_shipping_form_ajax' => $add_shipping_form_ajax->createView(),
            'get_shippingMessenger_list_form_ajax' => $get_shippingMessenger_list_form_ajax->createView(),
            'get_shipmentDetail_list_form_ajax' => $get_shipmentDetail_list_form_ajax->createView(),
            'edit_shipment_form_ajax' => $edit_shipment_form_ajax->createView(),
            'get_location_detail_form_ajax' => $get_location_detail_form_ajax->createView(),
            'get_packageMessenger_form_ajax' => $get_packageMessenger_form_ajax->createView(),
            'get_reach_from_packageMessenger_form_ajax' => $get_reach_from_packageMessenger_form_ajax->createView(),
            'get_sale_packageMessenger_form_ajax' => $get_sale_packageMessenger_form_ajax->createView(),
            'assign_sale_form_ajax' => $assign_sale_form_ajax->createView(),
            'get_shipping_list_form_ajax' => $get_shipping_list_form_ajax->createView(),
            'get_vehicle_list_form_ajax' => $get_vehicle_list_form_ajax->createView(),
            'get_driver_list_form_ajax' => $get_driver_list_form_ajax->createView(),
            'get_driver_form_ajax' => $get_driver_form_ajax->createView(),
            'get_vehicle_form_ajax' => $get_vehicle_form_ajax->createView(),
            'set_new_driver_form_ajax' => $set_new_driver_form_ajax->createView(),
            'set_new_vehicle_form_ajax' => $set_new_vehicle_form_ajax->createView(),
            'set_new_shipping_form_ajax' => $set_new_shipping_form_ajax->createView(),
            'search_ownerVehicle_form_ajax' => $search_ownerVehicle_form_ajax->createView(),
            'search_userDriver_form_ajax' => $search_userDriver_form_ajax->createView(),
            'search_userDriverCommercial_form_ajax' => $search_userDriverCommercial_form_ajax->createView(),
            'get_saleDetail_shipment_form_ajax' => $get_saleDetail_shipment_form_ajax->createView(),
            'get_supplier_data_form_ajax' => $get_supplier_data_form_ajax->createView(),
            'get_supplying_data_form_ajax' => $get_supplying_data_form_ajax->createView(),
            'get_item_data_form_ajax' => $get_item_data_form_ajax->createView(),
            'get_shipment_from_saleDetail_form_ajax' => $get_shipment_from_saleDetail_form_ajax->createView(),
            'get_reach_from_saleDetail_form_ajax' => $get_reach_from_saleDetail_form_ajax->createView(),
            'match_nodes_taster_form_ajax' => $match_nodes_taster_form_ajax->createView(),
            'assign_route_form_ajax' => $assign_route_form_ajax->createView(),
            'calculate_price_form_ajax' => $calculate_price_form_ajax->createView(),
            'update_shipping_founding_form_ajax' => $update_shipping_founding_form_ajax->createView()
        );
        
        return $shippingBundle_routes;
    }
    
    public function get_sessionBundle_routes($taskEntity)
    {
        $get_user_form_ajax = $this->createCustomForm(
        'HomeBundle\Form\TaskType', $taskEntity, 'POST', 'get_user_form');
        
        $get_parentsLocation_form_ajax = $this->createCustomForm(
        'HomeBundle\Form\TaskType', $taskEntity, 'POST', 'get_parentsLocation_form');
        
        $get_childrenLocation_form_ajax = $this->createCustomForm(
        'HomeBundle\Form\TaskType', $taskEntity, 'POST', 'get_childrenLocation_form');
        
        $sessionBundle_routes = array(
            'get_user_form_ajax' => $get_user_form_ajax->createView(),
            'get_parentsLocation_form_ajax' => $get_parentsLocation_form_ajax->createView(),
            'get_childrenLocation_form_ajax' => $get_childrenLocation_form_ajax->createView()
        );
        
        return $sessionBundle_routes;
    }
    
    public function get_signupBundle_routes($taskEntity)
    {
        $get_territoriality_form_ajax = $this->createCustomForm(
        'HomeBundle\Form\TaskType', $taskEntity, 'POST', 'get_territoriality_form');
        
        $search_shipping_category_form_ajax = $this->createCustomForm(
        'HomeBundle\Form\TaskType', $taskEntity, 'POST', 'search_shipping_category_form');
        
        $get_final_location_user_form_ajax = $this->createCustomForm(
        'HomeBundle\Form\TaskType', $taskEntity, 'POST', 'get_final_location_user_form');
        
        $signupBundle_routes = array(
            'get_territoriality_form_ajax' => $get_territoriality_form_ajax->createView(),
            'search_shipping_category_form_ajax' => $search_shipping_category_form_ajax->createView(),
            'get_final_location_user_form_ajax' => $get_final_location_user_form_ajax->createView()
        );
                
        return $signupBundle_routes;
    }
    
    public function get_uploadproductBundle_routes($taskEntity)
    {
        $load_commercial_form_ajax = $this->createCustomForm(
        'HomeBundle\Form\TaskType', $taskEntity, 'POST', 'load_commercial_form');
        
        $get_stock_in_the_branch_form_ajax = $this->createCustomForm(
        'HomeBundle\Form\TaskType', $taskEntity, 'POST', 'get_stock_in_the_branch_form');
        
        $select_currency_form_ajax = $this->createCustomForm(
        'HomeBundle\Form\TaskType', $taskEntity, 'POST', 'select_currency_form');
        
        $uploadproductBundle_routes = array(
            'load_commercial_form_ajax' => $load_commercial_form_ajax->createView(),
            'get_stock_in_the_branch_form_ajax' => $get_stock_in_the_branch_form_ajax->createView(),
            'select_currency_form_ajax' => $select_currency_form_ajax->createView()
        );
        
        return $uploadproductBundle_routes;
    }
    
    public function get_dataminingBundle_routes($taskEntity)
    {
        $delete_keyword_user_form_ajax = $this->createCustomForm(
        'HomeBundle\Form\TaskType', $taskEntity, 'POST', 'delete_keyword_user_form');
        
        $get_datamining_location_form_ajax = $this->createCustomForm(
        'HomeBundle\Form\TaskType', $taskEntity, 'POST', 'get_datamining_location_form');
        
        $dataminingBundle_routes = array(
            'delete_keyword_user_form_ajax' => $delete_keyword_user_form_ajax->createView(),
            'get_datamining_location_form_ajax' => $get_datamining_location_form_ajax->createView()
        );
        
        return $dataminingBundle_routes;
    }
}
