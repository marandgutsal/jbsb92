        ...
        if ($request->isXMLHttpRequest()) {
            ...
            if (isset($_SESSION['loginSession'])) {
                ...
                $window = $em->createQuery(
                    ...
                    ms.modestoreId, ms2.modestoreId modestoreId2, u.userId 

                    FROM HomeBundle:Window w 
                    JOIN HomeBundle:User u 
                    WITH u.userId = w.user 
                    
                    JOIN HomeBundle:Modestore ms 
                    WITH w.windowModestore = ms.modestoreId 

                    JOIN HomeBundle:Modestore ms2 
                    WITH w.windowModestore2 = ms2.modestoreId 
                ...
                if (isset($window_e[0]['windowId']))
                {
                    ...
                    $modestoreId_value = $window_e[0]['modestoreId'];
                    $modestoreId2_value = $window_e[0]['modestoreId2'];
                ...
                $window_properties[0] = array(
                    ...
                    'modestoreId' => $modestoreId_value,
                    'modestoreId2' => $modestoreId2_value,
                    'userId' => $userId_value
                );
...
//                currentVideo 
    ...
    public function setWindowPropertiesAction (Request $request)
    {
        ...
        $modestoreId1 = $_POST['modestoreId'];
        $modestoreId2 = $_POST['modestoreId2'];
        $userId = $_POST['userId'];
...
//            }
            ...
            $user = $em->getRepository('HomeBundle:User')->findOneByUserId($userId);
            $window = $em->getRepository('HomeBundle:Window')->findOneByWindowId($windowId);
            $modestore1 = $em->getRepository('HomeBundle:Modestore')->findOneByModestoreId($modestoreId1);
            $modestore2 = $em->getRepository('HomeBundle:Modestore')->findOneByModestoreId($modestoreId2);
...
//            {
                ...
                $window->setWindowModestore($modestore1);
                $window->setWindowModestore2($modestore2);
                $window->setUser($user);
