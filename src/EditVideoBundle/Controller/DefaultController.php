    ...
    public function editVideoPropertiesAction(Request $request)
    {
        ...
        if ($request->isXMLHttpRequest()) {
            ...
            if ($portrait_editVideoProperties)
            {
                ...
                // upload content
                $carpeta = "files/".$userId."/".$videoId_editVideoProperties."/";
...
//                $destinationImage = $carpeta . $_FILES['portrait_editVideoProperties']['name'];
                ...
                if ($typeImage == "image/jpeg" OR $typeImage == "image/jpg" OR $typeImage == "image/png") {
                    ...
                    {
                        $destinationImage = $videoId_editVideoProperties . ".jpeg";
                    }
                    if ($typeImage == "image/jpg")
                    {
                        $destinationImage = $videoId_editVideoProperties . ".jpg";
                    }
                    if ($typeImage == "image/png")
                    {
                        $destinationImage = $videoId_editVideoProperties . ".png";
                    }
                    move_uploaded_file($filenameImage, $carpeta . $destinationImage);
